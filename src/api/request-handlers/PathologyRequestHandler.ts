...
export default class PathologyRequestHandler implements IPathologyRequestHandler {
  ...
  public SendCommand(request: any) {
    const Handle = {
      UpdatePathologyRequest: (request: UpdatePathologyRequest) =>
        this.UpdatePathologyRequestHandle(request),
      CreatePathologyRequest: (request: CreatePathologyRequest) =>
        this.CreatePathologyRequestHandle(request),
      FindOnePathologyRequest: (request: FindOnePathologyRequest) =>
        this.FindOnePathologyRequestHandle(request),
      FindAllPathologyRequest: (request: FindAllPathologyRequest) =>
        this.FindAllPathologyRequestHandle(request),
      RemovePathologyRequest: (request: RemovePathologyRequest) =>
        this.RemovePathologyRequestHandle(request),
    };
